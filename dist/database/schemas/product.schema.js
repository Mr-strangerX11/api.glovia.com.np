...
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], Product.prototype, "vendorEmail", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], Product.prototype, "vendorPhone", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: String, enum: ['vendor', 'admin', 'superadmin'] }),
    __metadata("design:type", String)
], Product.prototype, "uploadedBy", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose_2.Types.ObjectId, ref: 'User' }),
    __metadata("design:type", mongoose_2.Types.ObjectId)
], Product.prototype, "uploadedById", void 0);
__decorate([
...
exports.ProductSchema.index({ vendorId: 1 });
exports.ProductSchema.index({ vendorEmail: 1 });
exports.ProductSchema.index({ isActive: 1, isFeatured: 1 });
exports.ProductSchema.index({ vendorId: 1, isActive: 1 });
