...
export declare class BrandsService {
    ...
    constructor(brandModel: Model<Brand>, productModel: Model<Product>, productImageModel: Model<ProductImage>, orderItemModel: Model<OrderItem>, realtimeService: RealtimeService);
