...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get vendor list for admin dropdown' }),
...
], VendorsController.prototype, "getVendorList", null);
__decorate([
    (0, common_1.Get)('orders/my-orders'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get vendor own orders (vendor dashboard)' }),
    (0, swagger_1.ApiQuery)({ name: 'page', required: false, type: Number }),
    (0, swagger_1.ApiQuery)({ name: 'limit', required: false, type: Number }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get all products for a vendor (vendor store)' }),
    (0, swagger_1.ApiQuery)({ name: 'page', required: false, type: Number }),
    (0, swagger_1.ApiQuery)({ name: 'limit', required: false, type: Number }),
...
__decorate([
    (0, common_1.Get)(':vendorId/profile'),
    (0, swagger_1.ApiOperation)({ summary: 'Get vendor profile with summary' }),
    __param(0, (0, common_1.Param)('vendorId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], VendorsController.prototype, "getVendorProfile", null);
