...
let PromoCode = class PromoCode extends mongoose_2.Document {
};
...
], PromoCode.prototype, "discountPercentage", void 0);
__decorate([
...
exports.PromoCode = PromoCode = __decorate([
    (0, mongoose_1.Schema)({ timestamps: true, collection: 'promocodes' })
], PromoCode);
